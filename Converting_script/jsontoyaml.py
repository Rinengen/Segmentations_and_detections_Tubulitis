...
if __name__ == "__main__":
    base_input_path = "C:\\Users\\minik\\Desktop\\Tubules\\"
    base_output_path = "C:\\Users\\minik\\Desktop\\Tubules\\Yolo_dataset"
    ...
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "images"),
        input_json_path=os.path.join(base_input_path, "images\\train.json"),
     ...
     # Processing training dataset 
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "test_images"),
        input_json_path=os.path.join(base_input_path, "test_images\\test.json"),
    ...
    create_yaml(
        input_json_path=os.path.join(base_input_path, "train_images\\train.json"),
        output_yaml_path=os.path.join(base_output_path, "data.yaml"),
        train_path="C:\\Users\\minik\\Desktop\\datasets\\tubulitis_to_YML\\yolo_dataset\\train\\images",
        val_path="C:\\Users\\minik\\Desktop\\datasets\\tubulitis_to_YML\\yolo_dataset\\valid\\images",
        test_path="C:\\Users\\minik\\Desktop\\datasets\\tubulitis_to_YML\\yolo_dataset\\test\\images"  # or None if not applicable
    )
